...
#include "ranger_interfaces/msg/detail/string__rosidl_typesupport_fastrtps_c.h"
...
using _String__ros_msg_type = ranger_interfaces__msg__String;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
bool cdr_serialize_ranger_interfaces__msg__String(
  const ranger_interfaces__msg__String * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
bool cdr_deserialize_ranger_interfaces__msg__String(
  eprosima::fastcdr::Cdr & cdr,
  ranger_interfaces__msg__String * ros_message)
{
  // Field name: data
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
size_t get_serialized_size_ranger_interfaces__msg__String(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
size_t max_serialized_size_ranger_interfaces__msg__String(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ranger_interfaces__msg__String;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
bool cdr_serialize_key_ranger_interfaces__msg__String(
  const ranger_interfaces__msg__String * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: data
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
size_t get_serialized_size_key_ranger_interfaces__msg__String(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _String__ros_msg_type * ros_message = static_cast<const _String__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ranger_interfaces
size_t max_serialized_size_key_ranger_interfaces__msg__String(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ranger_interfaces__msg__String * ros_message = static_cast<const ranger_interfaces__msg__String *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ranger_interfaces__msg__String(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ranger_interfaces__msg__String * ros_message = static_cast<ranger_interfaces__msg__String *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ranger_interfaces__msg__String(cdr, ros_message);
}

static uint32_t _String__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ranger_interfaces__msg__String(
...
static size_t _String__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ranger_interfaces__msg__String(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ranger_interfaces, msg, String)() {
