...
ranger_interfaces__msg__IMUAccel__create(void)
{
  ...
  ranger_interfaces__msg__IMUAccel * msg = (ranger_interfaces__msg__IMUAccel *)allocator.allocate(sizeof(ranger_interfaces__msg__IMUAccel), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ranger_interfaces__msg__IMUAccel));
  bool success = ranger_interfaces__msg__IMUAccel__init(msg);
  if (!success) {
...
ranger_interfaces__msg__IMUAccel__destroy(ranger_interfaces__msg__IMUAccel * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ranger_interfaces__msg__IMUAccel__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ranger_interfaces__msg__IMUAccel__Sequence__init(ranger_interfaces__msg__IMUAccel__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ranger_interfaces__msg__IMUAccel * data = NULL;

  if (size) {
    data = (ranger_interfaces__msg__IMUAccel *)allocator.zero_allocate(size, sizeof(ranger_interfaces__msg__IMUAccel), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ranger_interfaces__msg__IMUAccel__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ranger_interfaces__msg__IMUAccel__fini(&data[i - 1]);
      }
...
ranger_interfaces__msg__IMUAccel__Sequence__fini(ranger_interfaces__msg__IMUAccel__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ranger_interfaces__msg__IMUAccel__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ranger_interfaces__msg__IMUAccel__Sequence * array = (ranger_interfaces__msg__IMUAccel__Sequence *)allocator.allocate(sizeof(ranger_interfaces__msg__IMUAccel__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ranger_interfaces__msg__IMUAccel__Sequence__init(array, size);
  if (!success) {
...
ranger_interfaces__msg__IMUAccel__Sequence__destroy(ranger_interfaces__msg__IMUAccel__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ranger_interfaces__msg__IMUAccel__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ranger_interfaces__msg__IMUAccel__Sequence__are_equal(const ranger_interfaces__msg__IMUAccel__Sequence * lhs, const ranger_interfaces__msg__IMUAccel__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ranger_interfaces__msg__IMUAccel__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ranger_interfaces__msg__IMUAccel__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ranger_interfaces__msg__IMUAccel);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ranger_interfaces__msg__IMUAccel * data =
      (ranger_interfaces__msg__IMUAccel *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ranger_interfaces__msg__IMUAccel__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ranger_interfaces__msg__IMUAccel__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ranger_interfaces__msg__IMUAccel__copy(
