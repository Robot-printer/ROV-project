...
#include "ranger_interfaces/msg/detail/imu_gyro__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ranger_interfaces::msg::IMUGyro;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ranger_interfaces::msg::IMUGyro *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ranger_interfaces::msg::IMUGyro *>(
    untyped_ros_message);
...
{
  return &ranger_interfaces::msg::typesupport_fastrtps_cpp::_IMUGyro__handle;
}
