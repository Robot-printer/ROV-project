...
#include "ranger_interfaces/msg/detail/string__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ranger_interfaces::msg::String & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ranger_interfaces::msg::String & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ranger_interfaces::msg::String;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ranger_interfaces::msg::String *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ranger_interfaces::msg::String *>(
    untyped_ros_message);
...
{
  return &ranger_interfaces::msg::typesupport_fastrtps_cpp::_String__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ranger_interfaces, msg, String)() {
  return &ranger_interfaces::msg::typesupport_fastrtps_cpp::_String__handle;
}
