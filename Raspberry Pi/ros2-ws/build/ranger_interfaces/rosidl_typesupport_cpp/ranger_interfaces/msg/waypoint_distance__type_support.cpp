...
static const _WaypointDistance_type_support_symbol_names_t _WaypointDistance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ranger_interfaces, msg, WaypointDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ranger_interfaces, msg, WaypointDistance)),
  }
};
...
{
  return &::ranger_interfaces::msg::rosidl_typesupport_cpp::WaypointDistance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ranger_interfaces, msg, WaypointDistance)() {
  return get_message_type_support_handle<ranger_interfaces::msg::WaypointDistance>();
}
