...
static const _UltrasonicDistance_type_support_symbol_names_t _UltrasonicDistance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ranger_interfaces, msg, UltrasonicDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ranger_interfaces, msg, UltrasonicDistance)),
  }
};
...
{
  return &::ranger_interfaces::msg::rosidl_typesupport_cpp::UltrasonicDistance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ranger_interfaces, msg, UltrasonicDistance)() {
  return get_message_type_support_handle<ranger_interfaces::msg::UltrasonicDistance>();
}
